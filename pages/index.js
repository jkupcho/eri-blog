  ...
  render() {
    return (
        <div>
            ...
            <div className="column is-half is-offset-one-quarter">
              ...
              <div className="columns">
                <div className="column">
                  ...
                  <div className="has-text-centered service-icon">
                    <span className="icon is-large">
                      <i className="has-text-centered fa fa-shower"></i>
                    </span>
                  </div>
                ...
                <div className="column">
                  ...
                  <div className="has-text-centered service-icon">
                    <span className="icon is-large">
                      <i className="has-text-centered fa fa-cutlery"></i>
                    </span>
                  </div>
                ...
                <div className="column">
                  ...
                  <div className="has-text-centered service-icon">
                    <span className="icon is-large">
                      <i className="has-text-centered fa fa-wrench"></i>
                    </span>
                  </div>
          ...
          <div className="columns section-divider">
            <div className="column is-half is-offset-one-quarter">
              <h1 className="title is-1 has-text-centered">Recent Remodels</h1>
            </div>
          </div>
        </div>
    )
